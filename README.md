...
- فیلتر بهتر کارکتر های اضافی که هوش مصنوعی تولید می کند. حدف کارکتر ! در پاسخ هوش مصنوعی
- تبدیل کارکتر ** به <strong> برای نمایش در وردپرس
- امکان فعال و غیرفعال کردن حالت شب
- تولید ستاره های rating و ذخیره در دستابیس
